...
from story_generation_driver import (
...
class TestStoryGenerationDriver(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pubsub_patcher = patch('story_generation_driver.get_pubsub')
    ...
    @patch('story_generation_driver.get_timestamped_ttv_dir')
    ...
    @patch('story_generation_driver.text_to_video')
    @patch('story_generation_driver.parse_tts_interface')
